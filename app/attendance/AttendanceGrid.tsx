...
//   if (user?.email !== 'prasantshukla89@gmail.com') {
//     return <div className="p-5 text-center">You are not authorized to view this page.</div>;
//   }

//   return (
//     <div className="p-5">
//       <h1 className="text-2xl font-bold text-center mb-5">ATTENDANCE SYSTEM</h1>
//       <form onSubmit={handleAddStudent} className="mb-5 flex justify-center items-center">
//         <input
//           type="text"
//           value={newStudentName}
//           onChange={(e) => setNewStudentName(e.target.value)}
...
//           <thead>
//             <tr>
//               <th className="border p-2 bg-gray-200">Student Name</th>
//               {Array.from({ length: 24 }, (_, i) => (
//                 <th key={i} className="border p-2 bg-gray-200 text-center">{i + 8}</th>
//               ))}
